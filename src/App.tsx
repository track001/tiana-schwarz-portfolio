...
const projects: Project[] = [
  {
    ...
    image: "/images/brawn-preview.png",
    live:
      "https://track001.github.io/Battle-of-Brawn-2025-Competition-System/",
    github:
  ...
  },
  {
    ...
    image: "/images/bubby-wayback-preview.png",
...
const resumes: Resume[] = [
  {
    ...
    file: "/resumes/Tiana-Schwarz-Technical-Resume.pdf",
  },
  {
    number: "02",
    title: "Routesetting",
    ...
    file: "/resumes/Tiana-Schwarz-Routesetting-Resume.pdf",
  },
];
type TimelineItem = {
  id: string;
...
const timeline: TimelineItem[] = [
...

  {
    ...
    summary:
      "Earned USA Climbing Level 1 Routesetter certification.",
...

  {
    ...
    tags: ["SECRET Clearance", "Powershell Scripts", "Sustainment", "STIGS", "ACAS"],
    type: "work",
  },

  {
    ...
    title: "Security+",
    summary:
      "Earned CompTIA Security+ certification.",
...

  {
    ...
    location: "Colorado Springs, CO",
    summary:
      "Graduated cum laude from the University of Colorado.",
...
export default function App() {
  const [openTimelineItem, setOpenTimelineItem] =
...
<header className="nav">
  <div className="nav-identity">
    ...
    <div className="nav-contact">
      <a href="mailto:schwarztiana@gmail.com">
        schwarztiana@gmail.com
      </a>

      <span>|</span>

      <a href="tel:+17207175523">
        (720) 717-5523
      </a>
    </div>
  </div>
        ...
        <section className="hero" id="top">
          <div className="hero-copy">
            <div className="eyebrow">
              COMPUTER SCIENCE • CYBER • CLIMBING
            </div>
            ...
            <p className="hero-description">
              Computer science graduate working in cyber mission analysis with
              a background in cybersecurity test and evaluation, software,
              automation, and a love for technical documentation.
            </p>

            <p className="hero-description secondary">
              Outside of my 9-5 - I routeset, coach climbers, and build systems for
...
<section className="timeline-section" id="experience">
  <div className="timeline-heading">
    ...
    <p>
      <p>
      A timeline of my work, education, and other pursuits since graduating in 2023.
      </p>
    </p>
  </div>
      ...
      return (
        ...
        <section className="coming-section resume-section" id="resumes">
          <div className="section-heading">
            <div>
              ...
              <h2>I currently maintain both a STEM resume and a routesetting resume.</h2>

                <p>
                  Engineering and climbing have both become significant parts of my professional life.
                </p>
            </div>
          </div>
        ...
        <section className="coming-section" id="about">
          ...
          <div className="about-copy">
            ...
            <p>
            My career hasn't followed one straight line. I've worked in engineering,
  healthcare, research, and climbing, and I've learned something different
  from each of them. I like learning new things, doing work that matters,
  helping where I can, and leaving things better than I found them.
            </p>

            <p>
              Outside of my engineering work, I'm a routesetter and coach. I care
              about thoughtful movement, accessible climbing, competition
              operations, and building stronger climbing communities.
            </p>

            <p>
            I spend a lot of my time building things, asking questions, and picking
            up new skills. The projects here range from software and research to
            climbing tools and personal projects I've cared about to continuously improve.
            </p>
          </div>
        </section>
      </main>
